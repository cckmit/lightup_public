 ...
 */
package vip.xiaonuo.modular.lightup.enums;
...
public enum LightupCourseExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        LightupCourseExceptionEnum(Integer code, String message) {
        this.code = code;
