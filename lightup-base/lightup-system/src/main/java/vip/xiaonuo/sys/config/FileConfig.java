...
import vip.xiaonuo.core.file.modular.tencent.TenFileOperator;
...
public class FileConfig {
     ...
     * 默认文件存储的位置
     */
    public static final String DEFAULT_BUCKET = "tencentoss-1258650587";

    @Value("${TencentOss.COS_BUCKET}")
    public static String COS_BUCKET;

    @Value("${TencentOss.APPID}")
    ...
    public FileOperator fileOperator() {
        ...
        tenCosProperties.setSecretId(SecretId);
        tenCosProperties.setSecretKey(SecretKey);
        tenCosProperties.setAppId(APPID);
