        ...
        getLoginUser().then(response => {
          if (response.success) {
            ...
            if (data.avatar != null) {
              ...
              let avatarData = ''
              // avatarData = process.env.VUE_APP_API_BASE_URL + '/sysFileInfo/preview?id=' + data.avatar
              avatarData = 'https://lightup.leiwspider.cn/api/sysFileInfo/preview?id=' + data.avatar
